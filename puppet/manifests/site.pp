...
# node 'database.learning.puppetlabs.vm' {
#  include role::app1::database
#}
#node 'webserver.learning.puppetlabs.vm' {
...
node 'puppet-database.intelliment-labs.com' {
  include role::app::database
}
node /puppet-webserver.?\.intelliment-labs\.com/ {
  include role::app::webserver
}
node 'puppet-dns.intelliment-labs.com' {
  include role::server::dnsserver
}
